<#
Not aggressive script to perform clean-up on devices using sccm, for sccm refer to disk_cleanup_sccm.ps1
...
Detection script is located in disk_cleanup_intune_detection.ps1
#>
